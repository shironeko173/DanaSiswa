...
<body>
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
            ...
            <article class="blog-details">
              ...
              <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i>{{ $post->created_at->diffForHumans() }}</li>
                </ul>
              </div><!-- End meta top -->
 ...
 <footer id="footer">
  ...
  <script src="{!! asset('assets-blog/vendor/glightbox/glightbox.min.js') !!}"></script>
